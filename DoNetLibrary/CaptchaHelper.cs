...
namespace Common
{
    public class CaptchaHelper
    {
        ...
        {
            get { return this.GetRandomColors(); }
            private set { }
        }
        #endregion
        ...
        private Bitmap GetImage()
        {
            ...
            //创建绘图
            result = new Bitmap(this.verifyCodeText.Length * 16, 36);
            ...
            using (Graphics objGraphics = Graphics.FromImage(result))
            {
                ...
                using (SolidBrush objSolidBrush = new SolidBrush(this.fontColor))
                {
                    ...
                    this.AddNoiseLine(result, objGraphics);
        ...
        /// <param name="objBitmap"></param>
        /// <param name="objGraphics"></param>
        private void AddNoiseLine(Bitmap objBitmap, Graphics objGraphics)
        {
            using (Pen objPen = new Pen(Color.Red, 0))
            {
                Point p1 = new Point(10, objRandom.Next((objBitmap.Height / 2 - 10), objBitmap.Height));
                Point p2 = new Point(objRandom.Next(objBitmap.Width - 10), objRandom.Next((objBitmap.Height / 2 - 10), objBitmap.Height));
                Point p3 = new Point(objRandom.Next(objBitmap.Width - 20), objRandom.Next((objBitmap.Height / 2 - 10), objBitmap.Height));
                Point p4 = new Point(objBitmap.Width - 10, objRandom.Next((objBitmap.Height / 2 - 10), objBitmap.Height));
                objGraphics.DrawBezier(objPen, p1, p2, p3, p4);
            }
        }
        /// <summary>
        /// 获取随机颜色
        ...
        {
            return Color.FromArgb(new Random().Next(0, 255 * 255 * 255));
        }
        #endregion
